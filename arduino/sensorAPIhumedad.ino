...
const char* serverName = "http://192.168.192.50:3050/sensor";
...
void loop() {
  ...
  if ((millis() - lastTime) > timerDelay) {
    ...
    if(WiFi.status()== WL_CONNECTED){
      ...
      int httpResponseCode = http.POST("{\"nombre\":\"Erick Cugua\",\"correo\":\"ecugual@miumg.edu.gt\",\"no_carnet\":\"0902-21-3869\",\"latitud\":\"15.472378\",\"longitud\":\"-90.369280\",\"temperatura\":\"" + temperatura + "\",\"humedad\":\"" + humedad + "\"}");
